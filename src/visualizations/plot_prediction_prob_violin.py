...
def plot_violin(data: pd.DataFrame, out_filename: str) -> None:
    ...
    g = sns.catplot(x="model_type", y="P(correct|context)",
                ...
                data=data, kind="violin", split=False,
                height=4, aspect=.7, palette="Pastel1", scale="count", inner="box")
    #plt.tight_layout()
...
if __name__ == "__main__":
    ...
    "./prob_sheets/gpt-neo-sm_prob_test.tsv","./prob_sheets/gpt-neo-sm_trained_prob_test.csv", 
    "./prob_sheets/gpt3_probabilities_curie_test.csv", "./prob_sheets/gpt3_curie_trained_prob_test.csv"]
